...
function AdvanceCollectionReportMain() {
	...
	const handleFetchMemberwiseReport = async () => {
		...
		await axios
			.post(`${url}/advance_collection_report_memberwise`, creds, {
headers: {
...
"Content-Type": "application/json", // optional
			...
			setReportData(res?.data?.advance_collec_member_data?.msg)
			...
			populateColumns(res?.data?.advance_collec_member_data?.msg, memberwiseDemandVsCollectionHeader);
			}
	...
	const handleFetchGroupwiseReport = async () => {
		...
		await axios
			.post(`${url}/advance_collection_report_groupwise`, creds, {
			headers: {
			Authorization: `${tokenValue?.token}`, // example header
			"Content-Type": "application/json", // optional
			},
			...
			.then((res) => {
				...
				// console.log(res, "RESSSSS======>>>>", res?.data?.advance_collec_grp_data?.msg)
				...
				setReportData(res?.data?.advance_collec_grp_data?.msg)
				// setTotSum(res?.data?.msg.reduce((n, { credit }) => n + credit, 0))
				setMetadataDtls(`${userDetails?.brn_code}, Groupwise`)
				// setFetchedReportDate(res?.data?.dateRange)
				populateColumns(res?.data?.advance_collec_grp_data?.msg,groupwiseDemandVsCollectionHeader)
	...
	const handleFetchBranchwiseReport = async () => {
		...
		await axios
			.post(`${url}/advance_collection_report_branchwise`, creds, {
headers: {
Authorization: `${tokenValue?.token}`, // example header
"Content-Type": "application/json", // optional
},
			...
			.then((res) => {
				...
				setReportData(res?.data?.advance_collec_branch_data?.msg)
				// setTotSum(res?.data?.msg.reduce((n, { credit }) => n + credit, 0))
				setMetadataDtls(`${userDetails?.brn_code}, Groupwise`)
				// setFetchedReportDate(res?.data?.dateRange)
				populateColumns(res?.data?.advance_collec_branch_data?.msg, branchwiseDemandVsCollectionHeader);
				}
...
localStorage.clear()
	...
	const handleFetchFundwiseReport = async () => {
		...
		await axios
			.post(`${url}/advance_collection_report_fundwise`, creds, {
headers: {
Authorization: `${tokenValue?.token}`, // example header
"Content-Type": "application/json", // optional
},
			...
			.then((res) => {
				console.log("RESSSSS======>>>>___", res?.data)
				...
				setReportData(res?.data?.advance_collec_fund_data?.msg)
				// setTotSum(res?.data?.msg.reduce((n, { credit }) => n + credit, 0))
				setMetadataDtls(`${userDetails?.brn_code}, Groupwise`)
				// setFetchedReportDate(res?.data?.dateRange)
				populateColumns(res?.data?.advance_collec_fund_data?.msg, fundwiseDemandVsCollectionHeader)
...
const tokenValue = await getLocalStoreTokenDts(navigate);
		await axios
			.post(`${url}/advance_collection_report_cowise`, creds, {
			headers: {
			Authorization: `${tokenValue?.token}`, // example header
			"Content-Type": "application/json", // optional
			},
			...
			setReportData(res?.data?.advance_collec_co_data?.msg)
			// setTotSum(res?.data?.msg.reduce((n, { credit }) => n + credit, 0))
			setMetadataDtls(`${userDetails?.brn_code}, COwise`)
			// setFetchedReportDate(res?.data?.dateRange)
			populateColumns(res?.data?.advance_collec_co_data?.msg, cowiseDemandVsCollectionHeader);
...
export default AdvanceCollectionReportMain
